            ...
            <div className="Test10">
                <ul>
                    ...
                    {/* <li>
                        ...
                        <p>출연진:{this.state.movies[0].actor}  </p>
                        <p>감독:{this.state.movies[0].director}</p>
                        <p>개봉일:{this.state.movies[0].date} </p>
                    </li>
                    <li>
                        <img src={this.state.movies[1].poster} />
                        <h3>{this.state.movies[1].title} </h3>
                        <p>출연진:{this.state.movies[1].actor}  </p>
                        <p>감독:{this.state.movies[1].director}</p>
                        <p>개봉일:{this.state.movies[1].date} </p>
                    </li> */}
